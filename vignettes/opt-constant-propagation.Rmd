...
In cases where the value of certain constants are already known, expressions containing them are "propagated" or will get replaced with the value of the constant. 
